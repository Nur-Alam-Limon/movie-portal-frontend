...
export const UserSidebar = ({
  ...
  return (
    <aside className="lg:w-72 w-full bg-[#121212] text-white flex lg:flex-col flex-wrap items-start justify-start h-auto lg:min-h-screen border-r border-gray-700 shadow-lg">
