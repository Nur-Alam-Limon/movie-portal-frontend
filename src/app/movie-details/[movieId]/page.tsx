...
const MovieDetailsPage: React.FC<MovieDetailsProps> = ({ params }) => {
  ...
  return (
    <div className="block lg:flex container justify-between gap-10 items-start mx-auto py-24 text-white min-h-screen">
      <div className="basis-[60%]">
        ...
        <div className="flex flex-col justify-end pb-6 mt-8">
          ...
          <p className="dark:text-gray-300 text-gray-700 max-w-2xl">{movie.synopsis}</p>
        </div>

        {/* Movie Info */}
        <div className="mt-10 grid md:grid-cols-1 gap-6">
          <div className="space-y-4 text-md dark:text-gray-300 text-gray-700">
